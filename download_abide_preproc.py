...
def collect_and_download(derivative, pipeline, strategy, out_dir, less_than, greater_than, site, sex, diagnosis):
    ...
    diagnosis : string
        'asd_fv', 'tdc', or 'both' corresponding to the diagnosis of the
    ...
    for pheno_row in pheno_list[1:]:
        ...
        if (diagnosis == 'asd_fv' and row_dx != '1') or (diagnosis == 'tdc' and row_dx != '2'):
            continue
...
if __name__ == '__main__':
    ...
    # Required arguments
    parser.add_argument('-a', '--asd_fv', required=False, default=False, action='store_true',
